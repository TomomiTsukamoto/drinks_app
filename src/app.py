...
#必要なモジュールのインポート
import torch
from drink import transforms, Net
...
def predicts():
 ...
 #　画像ファイルに対する処理
            ...
            return render_template('../templates/src/result.html', drinkName=drinkName_, image=base64_data)
        return redirect(request.url)
    
    # GET メソッドの定義    
    elif request.method == 'GET':
        return render_template('../templates/src/index.html')
